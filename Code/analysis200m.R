...
track200m <- read.csv(file="track200mLong.csv")
track200m <- track200m[,-c(1:2)]
...
# Added 04-04-2022 for mixed model analysis
write.csv(fourYears200long, file="fourYears200long.csv")
...
# Figure out a way to create a table
