...
# 35, 35, 22, 8 percent in each cluster. 22 at bottom, 8 at top.
...
# 33 (start at 24), 21 (start at 25, decrease), 19 (start at 25, increase), 16 (low group), 11 (high group)
