...
boy800clusters <- kmlShape(boy800clds,3)
# 50 (start at 130), 27 (start at 142), 23 (start at 122)
kmlShape(boy800clds,4) # looks reasonable given small data set
...
girl800clusters <- kmlShape(girl800clds,3)
# 60 (start at 155), 26 (start at 162), 14 (start at 140)
kmlShape(girl800clds,4)
