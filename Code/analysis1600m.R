...
#    TRUE ~ 'M'
#  ))
write.csv(track1600m, file="track1600mLong.csv")
track1600m <- read.csv(file="track1600mLong.csv")
...
# Added 4-4-22 to facilitate analysis of mixed models for track data
write.csv(fourYears1600long, file="fourYears1600long.csv")
...
ggplot(data=fourYears1600long) +
  ...
  labs(x="Grade",y="Best Time (in seconds)",title="Best Times in 1600m by Grade")
